...
export function DocumentsExplorerHeader() {
  return (
    <header className="flex flex-col gap-4 border-b border-[#E5E7EB] bg-white px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex w-full flex-col gap-2 sm:ml-0 sm:w-auto sm:flex-row sm:items-center sm:gap-2">
          <Button
            type="button"
            variant="outline"
            className="h-11 min-h-11 w-full gap-2 border-[#E5E7EB] bg-white px-4 text-[13px] font-medium text-[#111827] shadow-sm sm:h-10 sm:min-h-10 sm:w-auto"
          >
          ...
          <Button
            type="button"
            className="h-11 min-h-11 w-full gap-2 border-0 bg-[#E2F33C] px-4 text-[13px] font-semibold text-[#111827] shadow-sm hover:bg-[#D4E82E] sm:h-10 sm:min-h-10 sm:w-auto"
          >
