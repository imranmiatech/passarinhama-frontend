...
//                     <div className="w-full bg-[#FFD000] py-3 px-4 text-center">
...
//                         <div className="w-full max-w-[1440px] items-center flex flex-col lg:flex-row gap-y-5 justify-between py-3 px-5">
...
//                                 <button className="font-semibold text-base w-full lg:w-fit leading-[150%] bg-[#EDEEF0] hover:bg-[#000000] px-5 py-2.5 rounded-2.5 rounded-[30px] text-black hover:text-[#FFFFFF] cursor-pointer transition-colors duration-200">Contact</button>
//                                 <button className="font-semibold text-base w-full lg:w-fit leading-[150%] bg-[#EDEEF0] hover:bg-[#000000] px-5 py-2.5 rounded-2.5 rounded-[30px] text-black hover:text-[#FFFFFF] cursor-pointer transition-colors duration-200">Ancien Extranet</button>
//                             </div>
//                         </div>
//                     </div>
...
//                             </h1>
//                         </div>
//                         <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:8 items-center mt-7 lg:mt-10 ">
//                             <div className="bg-white px-6 py-7 border border-[#E7E7E7] rounded-[20px] flex flex-col gap-y-4">
...
//                 {/*------------------------- part 05----------------------------- */}
//                 <div className="w-full py-5 md:py-10 lg:py-10 flex justify-center bg-[#000000] px-5 ">
//                     <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
//                         <button className="text-base text-[#212121] font-semibold leading-[150%] px-6 py-2.5 rounded-[40px] bg-[#FEDA00] hover:bg-[#E5C600] transition-colors duration-200 cursor-pointer">Administrateur</button>
//                         <button className="text-base text-[#212121] font-semibold leading-[150%] px-6 py-2.5 rounded-[40px] bg-[#FEDA00] hover:bg-[#E5C600] transition-colors duration-200 cursor-pointer">Commission</button>
//                         <button className="text-base text-[#212121] font-semibold leading-[150%] px-6 py-2.5 rounded-[40px] bg-[#97B9FF] hover:bg-[#7A9BFF] transition-colors duration-200 cursor-pointer">Membre Normal</button>
//                         <button className="text-base text-[#212121] font-semibold leading-[150%] px-6 py-2.5 rounded-[40px] bg-[#EDEEF0] hover:bg-[#D0D0D0] transition-colors duration-200 cursor-pointer">Auditeur</button>
//                         <button className="text-base text-[#212121] font-semibold leading-[150%] px-6 py-2.5 rounded-[40px] bg-[#EDEEF0] hover:bg-[#D0D0D0] transition-colors duration-200 cursor-pointer">Technicopro</button>
//                         <button className="text-base text-[#212121] font-semibold leading-[150%] px-6 py-2.5 rounded-[40px] bg-[#EDEEF0] hover:bg-[#D0D0D0] transition-colors duration-200 cursor-pointer">Comité des copropriétés</button>
//                     </div>
//                 </div>
